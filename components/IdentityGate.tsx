    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-50">
        <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-lg">
          <h1 className="mb-1 text-xl font-semibold text-zinc-900">Welcome to Sheets</h1>
          <p className="mb-6 text-sm text-zinc-500">Set a display name or continue with Google.</p>
          ...
          <button
            ...
            disabled={busy}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 disabled:opacity-50"
          >
            <GoogleIcon />
            Sign in with Google
          </button>
